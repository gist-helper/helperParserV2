...
def parsing_menu(row_range: list, data_sheet: list, langType: int, bldgType: int, except_row: list = []):
    menu = ""
...
def parsing_lunch(endpoint: list, data_sheet: list, langType: int, dateType: int, bldgType: int, except_row: list = []):
    row_range = endpoint[LUNCH]
    menu = parsing_menu(row_range, data_sheet, langType, bldgType, except_row)
    special = ""
