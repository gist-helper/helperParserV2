...
def parsing(excel_path: str, bldgType: int, langType: int) -> list:
    ...
    if bldgType == 0 & langType == 0: #1학 한글 엑셀
...
if __name__ == "__main__":
    ...
    if Mode == 0:
        ...
        if exists(excel_path_1_1):
            parsing_result_1.extend(parsing(excel_path_1_1, BLDG1_1ST, ENG)) #1학 1층, 영어
        ...
        if len(sys.argv) == 1:
            ...
            print("-------------------------------------------------")
            print("saving json...")
            if exists(excel_path_1) & exists(excel_path_1_1):
